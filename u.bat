@echo off 
set WS=%~dp0
set UNITY_PATH="C:\Program Files\Unity2017\Editor\Unity.exe"
set PROJECT_PATH="%WS%"
...
%UNITY_PATH% -quit -batchmode -projectPath %PROJECT_PATH% -executeMethod BuildTool.Build -destinationPath %DESTINATION_PATH%